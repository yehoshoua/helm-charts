...
{{- define "grafana-agent.labels-daemonset" -}}
helm.sh/chart: {{ include "grafana-agent.chart" . }}
{{ include "grafana-agent.selectorLabels-daemonset" . }}
{{- if index .Values "$chart_tests" }}
app.kubernetes.io/version: "vX.Y.Z"
app.kubernetes.io/managed-by: {{ .Release.Service }}
{{- else }}
...
{{- define "grafana-agent.labels-deployment" -}}
helm.sh/chart: {{ include "grafana-agent.chart" . }}
{{ include "grafana-agent.selectorLabels-deployment" . }}
{{- if index .Values "$chart_tests" }}
app.kubernetes.io/version: "vX.Y.Z"
app.kubernetes.io/managed-by: {{ .Release.Service }}
{{- else }}
...
{{- define "grafana-agent.labels-statefulset" -}}
helm.sh/chart: {{ include "grafana-agent.chart" . }}
{{ include "grafana-agent.selectorLabels-statefulset" . }}
{{- if index .Values "$chart_tests" }}
app.kubernetes.io/version: "vX.Y.Z"
app.kubernetes.io/managed-by: {{ .Release.Service }}
{{- else }}
...
{{- end }}
{{- define "grafana-agent.selectorLabels-daemonset" -}}
app.kubernetes.io/name: {{ include "grafana-agent.name" . }}-daemonset
app.kubernetes.io/instance: {{ .Release.Name }}-daemonset
{{- end }}
{{- define "grafana-agent.selectorLabels-deployment" -}}
app.kubernetes.io/name: {{ include "grafana-agent.name" . }}-deployment
app.kubernetes.io/instance: {{ .Release.Name }}-deployment
{{- end }}
{{- define "grafana-agent.selectorLabels-statefulset" -}}
app.kubernetes.io/name: {{ include "grafana-agent.name" . }}-statefulset
app.kubernetes.io/instance: {{ .Release.Name }}-statefulset
{{- end }}
